...
function handleGenerateClick(e) {
    ...
    loadFile("invoice_template.docx", function(error, content) {
        if (error) {
        ...
        const row = `<tr>
            ...
            <td>
                <div style="display: flex; gap: 0.5rem;">
                    ...
                    <button class="generate-btn" data-id="${d._id}" style="padding: 4px 8px; font-size: 0.9em; background: rgba(46, 160, 67, 0.2); border: none; border-radius: 4px; color: #3fb950; cursor: pointer;">📄 Generate</button>
                </div>
            </td>
        </tr>`;
